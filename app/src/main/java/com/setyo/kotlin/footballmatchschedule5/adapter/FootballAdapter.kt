...
class FootballAdapter(mContext: Context, data: List<EventItem>, val listener: (EventItem) -> Unit) : RecyclerView.Adapter<FootballAdapter.MyHolder>() {

    var eventData : List<EventItem>
    ...
    class MyHolder(itemView : View) : RecyclerView.ViewHolder(itemView) , View.OnClickListener{
        ...
        fun bind(get: EventItem, listener: (EventItem) -> Unit, mContext: Context) {
