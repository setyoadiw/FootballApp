...
import com.setyo.kotlin.footballmatchschedule5.presenter.DetailPresenterImp
...
//    lateinit var dataTeamDetail : java.util.ArrayList<TeamsItem>
    ...
    private fun getDataAndInitiate() {
        ...
        val dataParcel = intent.extras.getParcelable<EventItem>("dataParcel")
    ...
    private fun initPresenter() {
        presenter = DetailPresenterImp(this,gson,api, this!!.context!!)
